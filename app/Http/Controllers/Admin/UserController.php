...
class UserController extends Controller
{
    public function __construct()
    {
        $this->middleware(function ($request, $next){
            ...
            abort(403,"You don't have enough permission to access this sate ADMIN ONLY !");
        });
    }
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('avatar')){
            ...
            $file_path_database = $file_path->store('images/users', 'public');
            $new_user->avatar = $file_path_database;
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->file('avatar')){
            ...
            $file_path = $request->file('avatar');
            $file_path_database = $file_path->store('images/users', 'public');
            $user->avatar = $file_path_database;
        }
